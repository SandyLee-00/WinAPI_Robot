...
public:
	...
	void Update(TimeManager* timeManager, KeyManager* keyManager);
	void Render(HDC _dc);
...
public:
	...
	// 카메라 포커스 아웃 효과
	void FocusedOut(float _duration, Vector2 _targerPos);
...
private:
	...
	void FocusedOutUpdate();
	void FocusedOutRender(HDC _dc);
